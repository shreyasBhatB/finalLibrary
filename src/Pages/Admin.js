      ...
      <div className="container mt-5 ">
        {loading ? (
          ...
          <div className="border border-5 p-4  mb-4 bg-warning-subtle">
            <h1 className="mb- display-4 text-dark">Library Manager </h1>
                ...
                <div className="card">
                  ...
                  <div className="card-body d-flex flex-column align-items-center">
                    <div className="card-buttons mb-3">
                      <button
                       className={`btn ${option === "add" ? "btn-outline-success text-dark" : "btn-outline-danger text-dark"}`}
                      ...
                      <button
                            className={`btn ${option === "delete" ? "btn-outline-success text-dark" : "btn-outline-danger text-dark"}`}
                      ...
                      <button
                            className={`btn ${option === "update" ? "btn-outline-success text-dark" : "btn-outline-danger text-dark"}`}
                        ...
                        <div key={index} className="col-md-3 mb-4">
                          <div className="card book-card">
                            ...
                            <div className="card-body">
                              ...
                              <p className="card-text">
                                <strong>Publication :</strong> {book.Public}
                              </p>
                            </div>
                          </div>
                        </div>
